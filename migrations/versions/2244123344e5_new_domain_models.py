...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_project_filename', 'documents', ['project_id', 'filename'])
...
def downgrade() -> None:
    ...
    op.add_column('documents', sa.Column('uploader_id', sa.VARCHAR(length=36), nullable=False))
