...
class TestDocumentsService:
    ...
    @pytest.mark.asyncio
    async def test_upload_document_success(self, documents_service, mock_repository, mock_upload_file, sample_document):
    ...
    @pytest.mark.asyncio
    async def test_upload_document_without_optional_params(self, documents_service, mock_repository, mock_upload_file, sample_document):
        ...
        # Act
        result = await documents_service.upload_document(project_id, user_id, mock_upload_file)
    ...
    @pytest.mark.asyncio
    async def test_download_document_success(self, documents_service, mock_repository, sample_document):
    ...
    def test_update_document_success(self, documents_service, mock_repository, sample_document):
    ...
    def test_update_document_partial_update(self, documents_service, mock_repository, sample_document):
        ...
        # Act
        result = documents_service.update_document(document_id, user_id, filename=filename)
