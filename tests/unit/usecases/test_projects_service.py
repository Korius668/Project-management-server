...
class TestProjectsService:
    ...
    def sample_membership(self):
        return ProjectMembership(
            id=uuid4(), project_id=uuid4(), user_id=uuid4(), role=ProjectRole.viewer
        )
    ...
    def test_create_project_success(
        self, projects_service, mock_repository, sample_project
    ):
    ...
    def test_get_user_projects_success(self, projects_service, mock_repository):
        ...
        projects = [
            Project(
                id=uuid4(), name="Project 1", description="Desc 1", owner_id=user_id
            ),
            Project(
                id=uuid4(), name="Project 2", description="Desc 2", owner_id=user_id
            ),
        ]
    ...
    def test_invite_user_to_project_success(
        self, projects_service, mock_repository, sample_membership
    ):
    ...
    @pytest.mark.asyncio
    async def test_upload_project_documents_success(
        self, projects_service, mock_repository, mock_upload_files
    ):
    ...
    def test_get_project_documents_success(self, projects_service, mock_repository):
        ...
        # Assert
        mock_repository.get_project_documents.assert_called_once_with(
            project_id, user_id
        )
        assert result == documents
