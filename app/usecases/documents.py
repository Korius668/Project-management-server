...
class DocumentsService:
    ...
    async def upload_document(self,  project_id: UUID,   user_id: UUID,  file: UploadFile,
            name: Optional[str] = None, description: Optional[str] = None,
                            ) -> Document:
        """Upload a new document to a project."""
        return await self.repository.upload_document(project_id,user_id,file,name,description)
    ...
    def update_document(self, document_id: UUID,  user_id: UUID,
